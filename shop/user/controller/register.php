...
if(isset($_POST['submit'])){
   ...
   $is="INSERT INTO user(taikhoan,matkhau,email,sodt) VALUES ('$taikhoan','$matkhau','$email','$sodt')";
    $sql = mysqli_query($conn, $is);
  //echo  $_SESSION['id_khachhang'] = mysqli_insert_id($conn);
    if($sql){
                            ...
                            <form class="user" method="post" action="">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" 
                                            placeholder="Tài khoản"name="taikhoan">
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <input type="number " class="form-control form-control-user" id="exampleInputEmail"
                                        placeholder="telephone number"name="sodt">
                                </div>
