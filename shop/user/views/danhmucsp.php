<?php
$sql_sanpham="SELECT * FROM sanpham where  sanpham.id_danhmuc='$_GET[id]'";
                    ...
                    <div class="single-product col">
                        <div class="product-f-image">
                            ...
                            <div class="product-hover">
                                ...
                                <a href="?quanly=quanlysanpham&id=<?php echo $row_sanpham['masp'] ?>" class="view-details-link"><i class="fa fa-link"></i> See
                                    details</a>
                            </div>
                        </div>
